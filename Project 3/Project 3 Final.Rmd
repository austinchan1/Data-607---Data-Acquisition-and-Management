...
<b>"Machine learning" is the most popular term across the blogs we analyzed.  Not only is it the most popular term in 4/5 blogs, but it doesn't show the variability that other topics show.  
...
Also showing as a consistent front runner in our sectors analysis is "Disease", showing that the literature around data science and epidemiology is quite prevalent, and may make for a very lucrative career for aspiring data scientists.</b>  
...
At the most basic level, the most important skill any data scientist can possess is to the ability to communicate and facilitate the public's understanding in the interests of knowledge and growth.</b>   
